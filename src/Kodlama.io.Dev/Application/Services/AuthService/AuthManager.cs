...
public class AuthManager : IAuthService
{
    ...
    public AuthManager(IUserOperationClaimRepository userOperationClaimsRepository, ITokenHelper tokenHelper, IRefreshTokenRepository refreshTokenRepository)
    {
        _userOperationClaimRepository = userOperationClaimsRepository;
